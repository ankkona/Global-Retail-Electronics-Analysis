...
An end-to-end Business Intelligence project built using the **Global Electronics Retailer** dataset from **Maven Analytics**. The dashboard analyzes sales, products, brands, and regional performance to uncover actionable business insights through SQL & Power BI.

## 🚀 Tech Stack

- **SQL Server** : Data import, cleaning, joins & preparation
...
- Which brands create concentration risk?
- When should inventory be increased or reduced?
- Which sales channel offers the biggest growth opportunity?
- Which countries deserve logistics optimization?
- Where is the business overly dependent on specific markets or products?
